...
Dieses Projekt ist <b>Work-In-Progress</b> und der Datensatz wird laufend ergänzt.</b> Die verwendete Version von R ist 4.5.1.
...
Rekonstruierter Datensatz: 
- Semi-strukturiert: TSV (auch in einer Englischen Version)
- Strukturiert: XML, JSON
- Binär: RDS, Parquet
- Datenbank: postgreSQL, SQLite

Beschreibende Statistiken (TSV):
